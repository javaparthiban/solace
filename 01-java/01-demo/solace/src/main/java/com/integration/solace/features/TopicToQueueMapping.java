package com.integration.solace.features;
...
public class TopicToQueueMapping  {
    ...
    public static void main(String... args) throws JCSMPException {
        args = new String[3];
        args[0] = "tcps://mr-connection-ttyxp4di0f5.messaging.solace.cloud:55443";
        args[1] = "solace-cloud-client@vpnparthiban";
        args[2] =  "oqmcl2vt0cd10b465glemucilv";
